...
\newtcolorbox{newText}{colback=yellow,on line,boxrule=0pt,boxsep=0pt,left=0pt,right=0pt,top=0pt,bottom=0pt}

\BeforeBeginEnvironment{minted}{\begin{codeFrame}}
    \AfterEndEnvironment{minted}{\end{codeFrame}}

\newcommand{\alexlistingcaption}[3]{\caption[#1 #2]{#2\ifIncludeFigures, Quelle: Eigenes Listing, Datei: \url{#3}\fi}}
...
% Eigener Befehl für Listingreferenz mit Zeilenreferenz
\newcommand{\LstSZ}[2]{(Listing \ref{#1}, S. \pageref{#1}, Z. #2)}

\newcommand{\LstS}[1]{(Listing \ref{#1}, S. \pageref{#1})}
