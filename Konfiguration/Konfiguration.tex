...
\babelhyphenation[ngerman]{For-mu-lar-an-wen-dung}
...
\DeclareTOCStyleEntry[numwidth=3em, pagenumberwidth=2em]{tocline}{figure} % Für Abbildungsverzeichnis
\DeclareTOCStyleEntry[numwidth=3em, pagenumberwidth=2em]{tocline}{table} % Für Tabellenverzeichnis