...
abstract class Massnahme implements Built<Massnahme, MassnahmeBuilder> {
  ...
  MassnahmenCharakteristika get massnahmenCharakteristika;
...
abstract class MassnahmenCharakteristika
    implements
        Built<MassnahmenCharakteristika, MassnahmenCharakteristikaBuilder> {
  String? get foerderklasse;
  String? get kategorie;
  String? get zielflaeche;
  String? get zieleinheit;
  String? get hauptzielsetzungLand;

  BuiltSet<String> get nebenziele;

  MassnahmenCharakteristika._();

  factory MassnahmenCharakteristika(
          [void Function(MassnahmenCharakteristikaBuilder) updates]) =
      _$MassnahmenCharakteristika;

  static Serializer<MassnahmenCharakteristika> get serializer =>
      _$massnahmenCharakteristikaSerializer;
}
