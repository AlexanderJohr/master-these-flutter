...
Bei Aufrufen der Methode wird das gesamte Widget neu gezeichne.
...
Im Fall einer Map werden der Schlüssel und der Wert durch einen \IC{:} voneinander getrennt und die Schlüsse-Wertepaare wiederum durch \IC{,} getrennt nacheinander aufgelistet (\IC{\{1: "erster Wert",2:"zweiter Wert"\}}).
...
\paragraph{Future}
Ein \IC{Future}-Objekt repräsentiert einen potenziellen einmaligen Wert, der in der erst in der Zukunft bereit steht.
...
\IC{countStream} liefert jede Sekunde einen neuen Wert, nämlich die aktuelle Sekunde - von 0 beginnent.
