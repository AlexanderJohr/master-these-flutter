...
%Die Freiheiten der Oberflächenentwicklung in \enquote{Flutter} sollen genutzt werden, um 
%visuellen Komponenten zu erstellen, die durch Einsatz des Strategie-Entwurfsmusters
%im hohen Maße anpassbar sind.



%Da die Aktualisierung von \enquote{Flutter}-Views nicht automatisch erfolgt, muss ein angemessenes 
