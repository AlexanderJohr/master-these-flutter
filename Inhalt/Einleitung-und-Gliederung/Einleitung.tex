...
beschäftigt sich Kapitel \ref{chap:Grundlagen} mit den Grundlagen des Frameworks und der zugrunde liegenden Programmiersprache \enquote{Dart}. \pdfcomment[icon=Note,color=yellow]{27.08.2021 2. Einschub von hier}

Die Konzeption der grafischen Benutzeroberfläche wird in Kapitel \ref{chap:Konzeption} durchgeführt. \pdfcomment[icon=Note,color=yellow]{27.08.2021 2. Einschub bis hier}
