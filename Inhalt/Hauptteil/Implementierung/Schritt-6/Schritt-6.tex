...
Die Anzeige der Werte in den Tabellenzellen ist dagegen unterschiedlich \LstZ{\ref{lst:Schritt6buildSelectableCell}}{44-50}.
...
Jedes Element des \enquote{BuiltSet} \IC{nebenziele} \Z{47} wird über die Methode \IC{map} jeweils in ein Element des \enquote{Widgets} \IC{Text} konvertiert \Z{48}.
...
ob das angeklickte Element bereits selektiert ist \Z{136}.
Sollte das der Fall sein,
so wird diese bereits selektierte Option, die nun abgewählt wurde,
mit der Methode \IC{remove} des \enquote{Builder}-Objektes aus dem \enquote{BuiltSet} entfernt \Z{137}.
...
Das übergebene \IC{selectionViewModel} unterstützt mit dem Typargument \IC{BuiltSet} die Auswahl von mehreren Optionen \Z{146}.
