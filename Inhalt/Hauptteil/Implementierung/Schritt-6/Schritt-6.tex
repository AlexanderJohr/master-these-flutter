...
Anders als bei den bisherigen Schlüssel-Werte-Paaren innerhalb des Objektes \IC{'massnahmenCharakteristika'} kann der Wert der Nebenziele nicht als einzelner \enquote{String} gespeichert werden \Lst{\ref{lst:Schritt6expectedJson}}.
...
so wird diese bereits selektierte Option, die nun erneut angewählt wurde, mit der Methode \IC{remove} des \enquote{Builder}-Objekts aus dem \IC{BuiltSet} entfernt \Z{137}.
