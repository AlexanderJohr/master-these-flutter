...
Da sie im Entwurfsmodus nicht gefüllt sein müssen, wird ihnen mit dem Suffix \IC{?} erlaubt, Null-Werte anzunehmen \Z{70-74}.
...
Im Unterschied zur Zelle des Maßnahmentitels können die \enquote{Getter}-Methoden des Wertetyps \IC{massnahmenCharakteristika} jedoch Null-Werte enthalten.
...
\DartSpec{165} Ist der Wert also nicht gefüllt, so wird der leere \enquote{String} \IC{""} als Argument übergeben.
...
über dessen Abkürzung \LstZ{\ref{lst:Schritt2KonvertierungDesModelsInDasViewModel}}{29-36}.
...
\LstZ{\ref{lst:Schritt2DieMethodeBuildSelectionCard}}{49}
...
\begin{alexlisting}{Schritt 2}{Die Methode \enquote{buildSelectionCard}}
  ...
  \label{lst:Schritt2DieMethodeBuildSelectionCard}
\end{alexlisting}
