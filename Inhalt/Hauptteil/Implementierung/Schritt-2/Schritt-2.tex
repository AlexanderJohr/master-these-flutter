...
Da sie auch im Entwurfsmodus nicht gefüllt sein können, wird ihnen mit dem Suffix \IC{?} erlaubt, auch Null-Werte anzunehmen \Z{70-74}.
...
Damit die Eingabefelder die neuen Werte eintragen können, muss das ViewModel oder die beobachtbaren Subjects bereitstellen bereit gestellt werden? \LstZ{\ref{lst:Schritt2MassnahmencharakteristikaWerdenDemViewModelHinzugefuegt}}{12-17}. \HP{Subjects und Observer in Schritt 1 erklären} 
...
Die Methode \IC{buildSelectionCard} bekommt dazu nur die Argumente für die Liste aller Auswahloptionen \IC{allChoices} \LstZ{\ref{lst:Schritt2MassnahmencharakteristikaSelektionskartenWerdenErgaenzt}}{49} und das Subjekt \IC{selectionViewModel} \Z{50} übergeben.
