...
Darüber hinaus wird die Funktion \IC{saveRecord} durch \IC{validateAndSave} ersetzt \Z{167}, welche ebenfalls in diesem Schritt implementiert wird. 
...
Oberhalb des vorhandenen \IC{FloatingActionButton} wird nun ein weiterer eingefügt, der zum Speichern des Entwurfs mit der Funktion \IC{saveDraft} genutzt werden soll \LstZ{\ref{lst:Schritt3FloatingActionButton}}{210-216}. Der ursprüngliche \IC{FloatingActionButton} versucht die Validierung und die anschließende Speicherung der Maßnahme mithilfe der neuen Funktion \IC{validateAndSave} \Z{224}.
