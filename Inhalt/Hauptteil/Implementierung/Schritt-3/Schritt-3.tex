...
außer einen weiteren hinzuzufügen: der Text für die Fehlermeldung \Z{143}.
...
Der Zugriff darauf ist einfach, da es über einen \enquote{GlobalKey} registriert wurde.\pdfcomment[icon=Note,color=yellow]{29.08.2021 Satz umformuliert}
...
Anderenfalls war mindestens ein Formularfeld invalide und damit bleibt nur die Rückgabe von \IC{false} übrig \Z{80}. \pdfcomment[icon=Note,color=yellow]{29.08.2021 Satz umformuliert}
