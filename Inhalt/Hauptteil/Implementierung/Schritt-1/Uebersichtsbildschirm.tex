...
\IC{storage.value.massnahmen} gibt den aktuellen Wert des \enquote{Streams} des \IC{storage}-Objekts zurück und greift auf die Liste der Maßnahmen zu.
...
Die aktuellen Werte von jedem \IC{BehaviorSubject} werden über die \enquote{Getter}-Methode \IC{value} ausgelesen und anschließend der entsprechenden Eigenschaft des Objekts vom Wertetyp \IC{Massnahme} zugewiesen.
