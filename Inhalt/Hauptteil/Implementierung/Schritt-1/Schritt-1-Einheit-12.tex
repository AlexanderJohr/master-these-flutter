...
\subsection{Generierung des \enquote{Mocks} \pdfcomment[icon=Note,color=yellow]{29.08.2021 neue Überschrift}}
...
In der Kommandozeile ist -- genau wie bei der Generierung der Wertetypen -- der Befehl \IC{flutter pub run build_runner build} einzugeben, damit der entsprechende Quellcode generiert wird. \pdfcomment[icon=Note,color=yellow]{29.08.2021 Satz umformuliert}
...
\subsection{Hilfsfunktionen für den Integrationstest\pdfcomment[icon=Note,color=yellow]{29.08.2021 neue Überschrift}}
...
\pdfcomment[icon=Note,color=yellow]{29.08.2021 neue Überschrift}Während der Integrationstest startet, öffnet sich als Erstes der Übersichtsbildschirm.
...
\subsection{Test des Selektionsbildschirms\pdfcomment[icon=Note,color=yellow]{29.08.2021 neue Überschrift}}
...
\subsection{Test der Eingabemaske\pdfcomment[icon=Note,color=yellow]{29.08.2021 neue Überschrift}}
...
\subsection{Test der Speicherung\pdfcomment[icon=Note,color=yellow]{29.08.2021 neue Überschrift}}
