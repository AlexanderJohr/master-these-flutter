...
Darunter ist unter anderem die \IC{contains} Methode,  welche erlaubt, das Vorhandensein eines Objektes im \enquote{Set} zu überprüfen.
...
Instanzvariable \IC{name} \Z{11} wird im Konstruktor \Z{16} zugewiesen.
...
Mehr zu \enquote{Map}-Literalen in dem Grundlagenkapitel \ref{sec:SetUndMapLiterale}.
