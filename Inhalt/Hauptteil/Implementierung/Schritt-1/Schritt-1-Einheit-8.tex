...
Bei den vorangestellten Punkten \IC{...} in Zeile 24 handelt es sich um den \enquote{spread operator}.
...
alle Elemente der inneren Liste in die äußere Liste einzufügen. \footcite[Vgl.][]{SpreadOperator}
  ...
  \begin{alexlisting}{Schritt 1}{Die Typdefinition \enquote{OnSelectCallback}}
    {Quellcode/Schritt-1/conditional_form/lib/widgets/massnahmen_table.dart}
