...
Die dazugehörigen Felder, Setter-Methoden, die konkrete Klasse und der restliche generierte Code sind in der gleichnamigen Datei mit der Endung \enqoute{.g.dart} (Zeile 11) zu finden.
...
In Wahrheit werden sie aber nur auf den \enquote{Builder}-Objekt angewendet.  Ebenfalls auffällig ist die Syntax \IC{b..guid}.  Statt eines \IC{.} zum Zugriff auf Attribute des Objekts wird hier der sogenannte Kaskadierungs-Operator \{..} benutzt.
