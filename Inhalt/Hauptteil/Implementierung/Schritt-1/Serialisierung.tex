...
Da diese unveränderbaren Werte noch bei der Erstellung des sogenannten \enquote{ViewModels} --  mehr dazu im Kapitel \HP{Einfügen} -- hilfreich werden, wurde sich für diese Bibliothek entschieden.
...
In Wahrheit werden sie aber nur auf den \enquote{Builder}-Objekt angewendet.  Ebenfalls auffällig ist die Syntax \IC{b..guid}.  Statt eines \IC{.} zum Zugriff auf Attribute des Objekts wird hier der sogenannte Kaskadierungs-Operator \IC{..} benutzt.
...
Der Befehl  \IC{flutter pub run build_runner build} stößt erneut die Quellcodegenerierung für den Wertetypen \IC{Storage} an.
