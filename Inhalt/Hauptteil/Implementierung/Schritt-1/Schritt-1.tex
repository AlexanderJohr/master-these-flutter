...
\begin{listing}[h]
  \inputminted[firstline=69, lastline=126] {dart}
  {Quellcode/Schritt-1/conditional_form/lib/widgets/selection_card.dart}
  
  \caption[Schritt 1 Die Funktion createMultipleChoiceSelectionScreen]{Die Funktion createMultipleChoiceSelectionScreen, Quelle: Eigenes Listing, \newline Datei: Quellcode/Schritt-1/conditional_form/lib/widgets/selection_card.dart} 
  ...
  \begin{listing}[h]
      \inputminted[firstline=34, lastline=67] {dart}
      {Quellcode/Schritt-1/conditional_form/lib/widgets/selection_card.dart}
      
      \caption[Schritt 1 Build Methode der SelectionCard]{Die Build Methode der SelectionCard, Quelle: Eigenes Listing, \newline Datei: Quellcode/Schritt-1/conditional_form/lib/widgets/selection_card.dart} 
      ...
      \begin{listing}[h]
          ...
          \caption[Schritt 1 Klasse SelectionCard]{Die Klasse SelectionCard, Quelle: Eigenes Listing, \newline Datei: Quellcode/Schritt-1/conditional_form/lib/widgets/selection_card.dart} 
