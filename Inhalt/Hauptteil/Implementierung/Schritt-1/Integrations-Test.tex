...
Über den \IC{tester} kann mit Hilfe der Methode \IC{pumpWidget} ein beliebiges \enquote{Widget} in der Test-Ausführung konstruiert werden.
...
Doch der Konstruktor von \Z{MassnahmenModel} erhält dieses Mal nicht das \IC{MassnahmenJsonFile}, sondern den entsprechenden \enquote{Mock} \Z{31}. 
...
Der Integrationstest öffnet nun den Auswahlbildschirm, in dem die Selektionskarte zum Setzen des letzten Status angewählt wird \LstZ{\ref{lst:Schritt1LetzterStatusWirdAusgewählt}}{98}.
...
Doch da stattdessen ein \enquote{Mock} verwendet wurde, passiert dies nicht.
