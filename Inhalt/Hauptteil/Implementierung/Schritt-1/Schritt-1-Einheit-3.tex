...
\begin{alexlisting}{Schritt 1}{Instanzvariable \enquote{massnahmen} gibt einen \enquote{SetBuilder} zurück}
...
mit dem generierten Serialisierer \IC{Storage.serializer} ein weiteres \enquote{JSON}-Objekt \Z{12}.
...
Er ist in Listing {\ref{lst:Schritt1MassnahmenDeserialisierenOhneFehlerUnitTest} im Anhang \ref{appendix:Schritt1Anhang} auf Seite \pageref{appendix:Schritt1Anhang} zu finden.
