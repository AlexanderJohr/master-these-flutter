...
Das erste Widget im Inhaltsbereich des \IC{Scaffold}-Elements ist ein \IC{WillPopScope}.
...
Das aktuelle \IC{Scaffold}-Objekt kann über \IC{ScaffoldMessenger.of} adressiert werden \Z{20}. Sollte bereits eine Mitteilung vorliegen, wird diese wieder versteckt, um Platz für die neue zu schaffen \Z{21}. Anschließend wird eine sogenannte \IC{Snackbar} mit dem entsprechenden Text angezeigt \Z{22-23}.
