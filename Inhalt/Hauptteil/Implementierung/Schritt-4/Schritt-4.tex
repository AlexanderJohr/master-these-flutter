...
\subsubsection{Hinzufügen der Bedingungen zu den Auswahloptionen}
...
Der Konstrukteur erhält einen weiteren Parameter für die Bedingung \Z{12}.
...
\subsubsection{Hinzufügen der Momentaufnahme aller ausgewählten Optionen im gesamten Formular}
...
\footcite[][]{DartEffectiveDartStylePREFERusingUnderscore}
\footcite[][]{KotlinHighOrderFunctionsAndLambdasUnderscoreForUnusedVariables}
. 
...
\subsubsection{Reagieren der Selektionskarte auf die ausgewählten Optionen}
...
\subsubsection{Reagieren des Auswahlbildschirms auf die ausgewählten Optionen}
...
\subsubsection{Hinzufügen der Momentaufnahme zur Validierung}
