...
\enquote{Sencha}, \enquote{Appcelerator}, \enquote{Adobe PhoneGap} und \enquote{Apache Cordova} miteinander verglichen.\pdfcomment[icon=Note,color=blue]{27.08.2021 Einschub bis hier}
...
noch immer höher ist und -- wenn auch stagnierend -- weiter steigt. \pdfcomment[icon=Note,color=blue]{27.08.2021 Einschub bis hier}
