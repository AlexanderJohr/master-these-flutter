...
Die Dokumentation von Jest enthält mehr Details zum Einsatz der Testbibliothek, welche für mehrere Frontend Frameworks kompatibel sind, die auf JavaScript basieren\footnoteL{\url{https://jestjs.io/docs/getting-started}}. Somit muss zum Erstellen der Unit-Tests immerhin nur dieses Framework studiert werden.
...
\begin{itemize}
    ...
    \begin{itemize} 
        ...
        \item Ein Rezept zum Testen vonm Nutzerverhalten wie dem Tab, dem Drag und dem Eingeben von Text \footnoteL{\url{https://flutter.dev/docs/cookbook/testing/widget/tap-drag}}
     \end{itemize}
