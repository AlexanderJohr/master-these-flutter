...
Dann ist der \IC{ChangeNotifier} in dem \enquote{Widget}, welches dem Parameter \IC{child} übergeben wird, und darüber hinaus in allen Kindelementen dieses \enquote{Widgets} verfügbar.
