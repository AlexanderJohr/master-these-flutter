...
Anschließend muss jeder \enquote{ChangeNotifier} als ein \IC{ChangeNotifierProvider} registriert werden \LstZ{\ref{lst:MultiProvider}}{7}. 
...
Dann ist der \enquote{ChangeNotifier} in dem \enquote{Widget}, welches dem Parameter \IC{child} übergeben wird, und darüber hinaus in allen Kindelementen dieses \enquote{Widgets} verfügbar.
Über einen \IC{Consumer} kann in der Oberfläche auf Änderungen des \enquote{ChangeNotifier} reagiert werden \Lst{\ref{lst:Consumer}}.
...
Sendet das \IC{BehaviorSubject} \IC{_cart} ein neues Ereignis \Z{4},
