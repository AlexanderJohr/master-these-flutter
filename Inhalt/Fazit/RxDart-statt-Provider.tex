...
wodurch er gleichzeitig ein neues Ereignis sendet \pdfcomment[icon=Note,color=yellow]{27.08.2021 1. Einschub von hier} \Z{4}.
...
ungeachtet dessen, ob der Wert derselbe ist.  \pdfcomment[icon=Note,color=yellow]{27.08.2021 1. Einschub bis hier} 
