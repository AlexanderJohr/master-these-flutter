...
Dann ist der \IC{ChangeNotifier} in dem Widget, welches dem Parameter \IC{child} übergeben wird, und darüber hinaus in allen Kinderelementen dieses Widgets verfügbar.
...
und stellt beide über die Getter-Methoden \IC{sink} und \IC{stream} zur Verfügung.
...
-- wie zum Beispiel die Getter-Methode \IC{value} für den zuletzt übermittelten Wert.
